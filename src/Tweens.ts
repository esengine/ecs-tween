module es {
    ...
    export class Vector2Tween extends Tween<Vector2> {
        ...
        protected updateValue() {
            this._target.setTweenedValue(Lerps.easeVector2(this._easeType, this._fromValue, this._toValue, this._elapsedTime, this._duration));
        }
    ...
    export class RectangleTween extends Tween<Rectangle> {
        ...
        protected updateValue() {
            this._target.setTweenedValue(Lerps.easeRectangle(this._easeType, this._fromValue, this._toValue, this._elapsedTime, this._duration));
        }
